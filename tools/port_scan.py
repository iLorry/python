...
def create_parser():
    ...
    parser = argparse.ArgumentParser(
        description='Scan the hosts\'s port.', prefix_chars='-/')
    ...
    parser.add_argument(
        ...
        default=1,
        type=int,
        help='The begin of the IP segment.',
        metavar='1')
    parser.add_argument(
        '-e',
        '/e',
        ...
        default=None,
        type=int,
        help='The end of the IP segment.',
        metavar='254')
    parser.add_argument(
        '-p',
        '/p',
...
def main():
    ...
    while args.begin <= args.end:
        ...
        for port in ports:
            ...
            t = threading.Thread(
                target=port_scanner, args=(host, int(port), args.verbose))
            t.start()
